...
func TestParseMaskCIDR(t *testing.T) {
	tests := []struct {
		...
		{"/31", 31, "255.255.255.254", "0xfffffffe", "0.0.0.1", 2},
		{"/30", 30, "255.255.255.252", "0xfffffffc", "0.0.0.3", 2},
		{"/16", 16, "255.255.0.0", "0xffff0000", "0.0.255.255", 65534},
		{"/0", 0, "0.0.0.0", "0x00000000", "255.255.255.255", 4294967294},
		{"/1", 1, "128.0.0.0", "0x80000000", "127.255.255.255", 2147483646},
	}
...
func TestParseNetwork(t *testing.T) {
	tests := []struct {
		...
		{"10.0.0.1/31", "10.0.0.1", 31, "10.0.0.0", "10.0.0.1", "10.0.0.0", "10.0.0.1", 2},
		{"10.0.0.1/0", "10.0.0.1", 0, "0.0.0.0", "255.255.255.255", "0.0.0.1", "255.255.255.254", 4294967294},
		{"10.0.0.1/1", "10.0.0.1", 1, "0.0.0.0", "127.255.255.255", "0.0.0.1", "127.255.255.254", 2147483646},
	}
	for _, tt := range tests {
